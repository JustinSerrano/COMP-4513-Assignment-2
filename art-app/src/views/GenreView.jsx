  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow p-8 flex flex-col items-center">
        ...
        {/* Dropdown List */}
        <div className="mb-6">
          <label htmlFor="genreSelect" className="block mb-2 font-bold text-gray-700">Select a Genre to View Paintings</label>
          <select
            id="genreSelect"
            ...
            defaultValue=""
          >
            <option value="" disabled>-- Choose a genre from the list --</option>
            {genres.map(genre => (
        ...
        {selectedGenre && (
          <div className="flex w-full justify-between mt-4">
            ...
            {/* Left Side Content */}
            <div className="w-1/2 p-4 bg-white shadow rounded-lg flex flex-col space-y-4">
              {/* Genre Image */}
              <div
                className="flex-shrink-0 mr-4"
              >
                <img
                  src={`/art-images/genres/${selectedGenre.genreId}.jpg`}
                  alt={`${selectedGenre.genreName} Image`}
              ...
              <div className="flex-grow">
                <h2 className="text-2xl font-bold mb-2">{selectedGenre.genreName}</h2>
                <p><strong>Description:</strong> {selectedGenre.description}</p>
